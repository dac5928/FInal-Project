...
My second data set will be the World Cities data-set from the DataComputing package. As my research question also relates to population, understanding which countries have the most populous cities.I found this data-set through our work with it during the DC exercises assignments. Althought we never deirectly utilized it, it is similar in structure to that of the ZipGeograpy data-set with the exception that it focuses on cities in countries other than the United States. As my research project has an international focus, it was important to utilize a data-set that reflected that focus. 
